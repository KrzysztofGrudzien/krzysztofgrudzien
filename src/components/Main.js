        ...
        <main className={styles.main}>
            <section className={styles.author}>
                ...
                <p className={styles.author__description}>
                    I’m an aspiring <b>FrontEnd Developer</b> and absolutly crazy about fishing and cooking man. Additional I am intersted <b>UX/UI</b> and web design of general meaning.
                </p>
                <p className={styles.author__description}>
