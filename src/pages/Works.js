                        ...
                        <>
                            <div className={styles.works__wrapper}>
                                ...
                                <article className={styles.article}>
                                    <h2 className={styles.article__title}>{repo.name}</h2>
                                    <p className={styles.article__description}>{repo.description}</p>
                                    <footer className={styles.article__footer}>
                                        <div className={styles.article__demo}>
                                            <img className={styles.article__icon} src={iconDemo} alt="icon preview." />
                                            <a href={repo.homepage} className={styles.article__link} target="_blank">Launch</a>
                                        </div>
                                        <div className={styles.article__code}>
                                            <img className={styles.article__icon} src={iconCode} alt="icon code." />
                                            <a href={repo.html_url} className={styles.article__link} target="_blank">GitHub</a>
                                        </div>
                                    </footer>
                                </article>
                                <div className={styles.works__lists}>
                                    <ul className={styles.works__list}>
                                        ...
                                        <li className={styles.works__item}>
                                            <b>Language:</b>{repo.language ? repo.language : "No data found"}
                                        </li>
                                        <li className={styles.works__item}>
                                            <b>Author:</b> {repo.owner.login}
                                        </li>
                                        <li className={styles.works__item}>
                                            <b>Last update:</b> {repo.updated_at.slice(0, 10)}
                                        </li>
                                    </ul>
                                </div>
                            </div>
